...
if [[ $1 != "cross" ]]
then
  # This converts the monophone MLF to a word internal triphone MLF.
  ...
  # This version converts it to a cross word triphone MLF, the short pause
...
# their corresponding triphones.  The script will also tie the transition
